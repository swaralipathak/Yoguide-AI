        ...
        <div className="about-container">
            ...
            <div className="about-main">
                ...
                <div className="developer-info">
                    ...
                    <p className="about-content">We are AI Enthusiastic, Content Creator, Tutor,
                    </p>
                    <h4>Contact</h4>
                    <a href="https://www.instagram.com"><p className="about-content">Instagram</p></a>
                    <a href="https://www.youtube.com"><p  className="about-content">Youtube</p></a>
                    <a href="https://github.com"><p  className="about-content">GitHub</p></a>
                </div>
            </div>
        </div>
    )
